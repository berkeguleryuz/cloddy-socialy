...
export default function AdminLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Top Bar */}
      <header className="fixed top-0 left-0 right-0 h-16 bg-surface border-b border-white/10 z-50">
        <div className="h-full flex items-center justify-between px-6">
          ...
          <Link href="/admin" className="flex items-center gap-3">
            ...
            <div>
              <span className="text-white font-bold">Cloddy</span>
      ...
      {/* Sidebar */}
      <aside className="fixed top-16 left-0 w-64 h-[calc(100vh-4rem)] bg-surface border-r border-white/10 overflow-y-auto">
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {item.badge && (
                  <span className="ml-auto px-2 py-0.5 text-xs font-bold bg-accent-orange rounded-full">
                    {item.badge}
                  </span>
                )}
              </Link>
