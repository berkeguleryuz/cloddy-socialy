...
export const CONTRACT_ADDRESSES = {
  ...
  CloddyPfp: process.env.NEXT_PUBLIC_CLODDY_PFP_ADDRESS || "0x0000000000000000000000000000000000000000",
  CloddyUsername: process.env.NEXT_PUBLIC_CLODDY_USERNAME_ADDRESS || "0x0000000000000000000000000000000000000000",
} as const;
